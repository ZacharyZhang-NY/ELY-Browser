...
impl MetalRenderer {
    pub fn new(instance_buffer_pool: Arc<Mutex<InstanceBufferPool>>) -> Self {
        ...
        // Servo publishes hardware offscreen frames as BGRA IOSurfaces.
        // Keep the original NV12 path for video surfaces and use this
        // pipeline for browser frames.
        let surface_bgra_pipeline_state = build_pipeline_state(
            &device,
            &library,
            "surface_bgra",
            "surface_vertex",
    ...
    fn draw_surfaces(
        ...
        for surface in surfaces {
            ...
            assert!(
                ...
                "unsupported CVPixelBuffer surface pixel format: {pixel_format:#x}"
            );
            ...
            if pixel_format == kCVPixelFormatType_420YpCbCr8BiPlanarFullRange {
                ...
                command_encoder.set_render_pipeline_state(&self.surface_bgra_pipeline_state);
